...
public class InsertCommand {
    ...
    // constructor for the InsertCommand class using the parsing of the userCommand
    ...
    // print the values of the InsertCommand
    ...
    // print the inserted TableInfo 
    public void printTableInfo() {
        
    }
   

    // the Execute method for the InsertCommand class
    public void Execute() {
        // Get the table info
